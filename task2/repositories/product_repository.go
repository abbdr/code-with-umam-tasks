...
func (repo *ProductRepository) Create(product *models.Product) error {
	query := "INSERT INTO products (name, price, stock, category_id) VALUES ($1, $2, $3, $4) RETURNING product_id"
...
func (repo *ProductRepository) GetByID(id int) (*models.Product, error) {
	query := "SELECT product_id, name, price, stock FROM products WHERE product_id = $1"
...
func (repo *ProductRepository) Update(product *models.Product) error {
	query := "UPDATE products SET name = $1, price = $2, stock = $3 WHERE product_id = $4"
